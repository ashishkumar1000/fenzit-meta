...
- The archive RPC + blockers preview ship **now, lazy-compiled** against the 15-7 tables (enrolments/assignments do not exist yet; calls fail loud until 15-7) — same precedent as `attendance_complete_setup` in 15-2.
